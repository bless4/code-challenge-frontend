                    ...
                    <div className={classes.imageInfo}>
                        <div className={classes.imageDescription}>
                            {images[current_image_num].description
                                ...
                                : capitalizeFirstLetter(
                                      images[current_image_num].alt_description
                                  )}
                        </div>
                        <CreatorHandle
                            profileURL={
                                images[current_image_num].user.links.html
                            }
                            imgURL={
                                images[current_image_num].user.profile_image
                                    .medium
                            }
                        ...
                        <div className={classes.dataItemsContainer}>
                            <ImageInfoDataItem
                                ...
                                value={timeAgo.format(
                                    new Date(
                                        images[current_image_num].created_at
                                    )
                                )}
                            />
                            <ImageInfoDataItem
                            ...
                            <ImageInfoDataItem
                                title="User location"
                                value={
                                    images[current_image_num].user.location ??
                                    '?'
                                }
                            />
                            <ImageInfoDataItem
                                title="Liked"
                                value={
                                    images[current_image_num].likes + ' times'
                                }
                            />
                            <ImageInfoDataItem
                                title="Width"
                                value={images[current_image_num].width + 'px'}
                            />
                            <ImageInfoDataItem
                                title="Height"
                                value={images[current_image_num].height + 'px'}
                            />
                        </div>
                    </div>
                </Fade>
