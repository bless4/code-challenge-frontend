        ...
        axios
            ...
            .then((res) => {
                const expectedAction = [
                    { payload: res.data, type: imageActions.GET_IMAGE },
                    { payload: false, type: imageActions.SET_IS_LOADING },
                ]
                fetchMock.getOnce(url, '')
                const store = mockStore({})
                return store
                    .dispatch(imageActions.getImage(pageNum))
                    .then(() => {
...
describe('action-modal', () => {
    ...
    it('action-modal-setSelectedImage', () => {
        ...
        expect(modalActions.setSelectedImage(selectedImage)).toEqual(
            expectedAction
        )
    })
    it('action-modal-setShowModalDetail', () => {
        ...
        expect(modalActions.setShowModalDetail(showModalDetail)).toEqual(
            expectedAction
        )
    })
})
