...
describe('reducer-image', () => {
    ...
    it('reducer-iamge-GET_IMAGE', () => {
        expect(
            imageReducer(initialStateImage, { type: GET_IMAGE, payload: '' })
        ).toEqual(initialStateImage)
    })
    it('reducer-iamge-SET_PAGE_NUMBER', () => {
        expect(
            imageReducer(initialStateImage, {
                type: SET_PAGE_NUMBER,
                payload: initialStateImage,
            })
        ).toEqual(initialStateImage)
    })
